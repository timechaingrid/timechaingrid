...
In addition to the above, this project has standards specific to its mission:

- **Privacy claims must be verifiable.** Discussions about adding features
  should consider their effect on the privacy posture. "Just add this
  third-party CDN" is not a constructive contribution.
- **No tokens, no shilling.** This is not a token project. Promoting
  cryptocurrency tokens, ICOs, or get-rich schemes in project channels is
  unacceptable behavior.
- **Anonymity is respected.** Contributors may operate pseudonymously.
  Attempting to dox a contributor — even through "innocent" off-channel
  research — is grounds for immediate removal.

## Enforcement Responsibilities

The maintainers are responsible for clarifying and enforcing our standards
...
reported to the maintainers at **conduct@timechaingrid.com**. All complaints
