 ...
 *
 *   - Grid view: square brass frame with corner rivets; 3×3 tile
 *     arrangement around a central gold ₿ tile — a spiral-real-estate
 *     silhouette.
 *
 * Both variants use the same brass + gold palette so the two domains
 * read as a single visual family; only the geometry distinguishes
 * them. Pure SVG, no external font (uses system serif for the ₿
 * glyph).
 */
